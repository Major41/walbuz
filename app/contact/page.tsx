  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            ...
            <Card className="p-8 border-0 bg-blue-50 hover:shadow-lg transition-shadow text-center">
              ...
              <h3 className="font-bold text-foreground text-lg mb-3">WhatsApp</h3>
          ...
          <Card className="p-8 border-0 bg-gradient-to-r from-primary/5 to-secondary/5 mb-16">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-lg text-foreground mb-3">Business Hours</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <p className="text-foreground/70">Monday - Friday</p>
                    <p className="font-semibold text-foreground">8:00 AM - 5:30 PM</p>
                  </div>
                  <div>
                    <p className="text-foreground/70">Saturday</p>
                    <p className="font-semibold text-foreground">9:00 AM - 2:00 PM</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-foreground">Available via WhatsApp</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-3xl font-bold text-foreground mb-6">Why WhatsApp?</h2>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold text-lg mt-0.5">✓</span>
                  <div>
                    <p className="font-semibold text-foreground">Instant Response</p>
                    <p className="text-foreground/70">Get quick replies to your inquiries</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold text-lg mt-0.5">✓</span>
                  <div>
                    ...
                    <p className="text-foreground/70">Share images, documents, and details easily</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold text-lg mt-0.5">✓</span>
                  <div>
                    ...
                    <p className="text-foreground/70">Send messages anytime, get responses during business hours</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold text-lg mt-0.5">✓</span>
                  <div>
                    ...
                    <p className="text-foreground/70">Skip the phone queue, get direct line access</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-blue-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-foreground text-center mb-12">What Can You Contact Us About?</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="p-6 border-0 bg-white hover:shadow-lg transition-shadow">
              <Globe className="w-8 h-8 text-primary mb-3" />
              <h3 className="font-bold text-foreground mb-2">Product Inquiries</h3>
              <p className="text-foreground/70 text-sm">Ask about our products and their availability</p>
            </Card>

            <Card className="p-6 border-0 bg-white hover:shadow-lg transition-shadow">
              <MessageCircle className="w-8 h-8 text-primary mb-3" />
              <h3 className="font-bold text-foreground mb-2">Quotations</h3>
              <p className="text-foreground/70 text-sm">Request customized quotes for your orders</p>
            </Card>

            <Card className="p-6 border-0 bg-white hover:shadow-lg transition-shadow">
              <Phone className="w-8 h-8 text-primary mb-3" />
              <h3 className="font-bold text-foreground mb-2">Bulk Orders</h3>
              <p className="text-foreground/70 text-sm">Special pricing for large quantity orders</p>
            </Card>

            <Card className="p-6 border-0 bg-white hover:shadow-lg transition-shadow">
              <MapPin className="w-8 h-8 text-primary mb-3" />
              <h3 className="font-bold text-foreground mb-2">Delivery Information</h3>
              <p className="text-foreground/70 text-sm">Ask about delivery to your location</p>
            </Card>

            <Card className="p-6 border-0 bg-white hover:shadow-lg transition-shadow">
              <Mail className="w-8 h-8 text-primary mb-3" />
              <h3 className="font-bold text-foreground mb-2">Payment Options</h3>
              <p className="text-foreground/70 text-sm">Learn about our flexible payment terms</p>
            </Card>

            <Card className="p-6 border-0 bg-white hover:shadow-lg transition-shadow">
              <Phone className="w-8 h-8 text-primary mb-3" />
              <h3 className="font-bold text-foreground mb-2">Support</h3>
              <p className="text-foreground/70 text-sm">General customer support and assistance</p>
            </Card>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-foreground mb-4">Let&apos;s Start a Conversation</h2>
          <p className="text-xl text-foreground/70 mb-8">
            Your satisfaction is our priority. Reach out today and let us know how we can help
          </p>
