  ...
  const services = [
    {
      ...
      description:
        "Complete stationery, printers, furniture, and office equipment for your workspace needs.",
      color: "bg-blue-50",
    },
    {
      icon: Package,
      ...
      description:
        "High-quality balls, kits, gym equipment for schools, clubs, and athletic facilities.",
      color: "bg-blue-50",
    },
    {
      icon: Zap,
      ...
      description:
        "Books, uniforms, desks, and comprehensive learning materials for educational institutions.",
      color: "bg-blue-50",
    },
    {
      icon: TrendingUp,
      ...
      description:
        "Cement, steel, tools, and hardware for construction and infrastructure projects.",
      color: "bg-blue-50",
    },
    {
      icon: Globe,
      ...
      description:
        "Pipes, fittings, tanks, and accessories for plumbing and water systems.",
      color: "bg-blue-50",
    },
  ];
  ...
  const whyChooseUs = [
    {
      ...
      description:
        "Consistent quality and dependable delivery every time, backed by years of experience.",
    },
    {
      icon: TrendingUp,
      title: "Affordable Pricing",
      description:
        "Competitive rates without compromising on quality of products and services.",
    },
    {
      icon: Globe,
      title: "Nationwide Delivery",
      description:
        "We deliver throughout Kenya, ensuring your supplies reach you wherever you are.",
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-xl text-foreground/80 mb-8 leading-relaxed">
              From office equipment to construction materials, sports gear to
              school supplies—WALBUZ delivers reliability, affordability, and
              nationwide service.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-foreground/70 max-w-2xl mx-auto">
              WALBUZ General Supplies Limited is a leading supplier of diverse
              products and services across Kenya.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <Card className="p-8 border-0 bg-blue-50 hover:shadow-lg transition-shadow">
              ...
              <p className="text-foreground/80">
                To provide reliable, affordable, and high-quality supplies
                nationwide, building lasting partnerships with our clients.
              </p>
            </Card>
            ...
            <Card className="p-8 border-0 bg-blue-50 hover:shadow-lg transition-shadow">
              ...
              <p className="text-foreground/80">
                To be Kenya&apos;s most trusted one-stop supplier of diversified
          ...
          <div className="bg-gradient-to-r from-primary to-secondary rounded-xl p-12 text-white">
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                ...
                <span>
                  <strong>Reliability:</strong> Consistent quality and
                  dependable service
                </span>
              </li>
              <li className="flex items-center gap-3">
              ...
              <li className="flex items-center gap-3">
                <span className="text-xl">✓</span>
                <span>
                  <strong>Efficiency:</strong> Fast processing and nationwide
                  delivery
                </span>
              </li>
            </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {whyChooseUs.map((item, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="p-8 border-0 bg-blue-50 hover:shadow-lg transition-shadow"
                >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card
                key={index}
                className="p-8 border-0 bg-white/10 backdrop-blur hover:bg-white/20 transition-colors"
              >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-foreground/70 mb-8">
            Contact WALBUZ today via WhatsApp for quick responses and
